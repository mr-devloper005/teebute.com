...
import { Plus, Tag, Settings, Search, Heart } from 'lucide-react'

const quickLinks = [
  { label: 'Browse classifieds', href: '/classifieds', icon: Tag },
  { label: 'Wishlist', href: '/dashboard/saved', icon: Heart },
  { label: 'Settings', href: '/settings', icon: Settings },
]

const createActions = [{ label: 'Post a classified (SELL)', href: '/create/classified', icon: Plus }]
